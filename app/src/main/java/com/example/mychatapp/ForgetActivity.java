        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(ForgetActivity.this, "Please check your email address", Toast.LENGTH_SHORT).show();
                    
                } else   {

                    Toast.makeText(ForgetActivity.this, "There is an issue", Toast.LENGTH_SHORT).show();
