                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            reference.child("Users").child(auth.getUid()).child("image").setValue(filePath).addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    ...
                                    Toast.makeText(ProfileActivity.this, "Write to db is successfull", Toast.LENGTH_SHORT).show();
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(ProfileActivity.this, "Write to db is not successfull", Toast.LENGTH_SHORT).show();
        ...
        reference.child("Users").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (image.equals("null")){
                    ...
                    imageViewCircleProfile.setImageResource(R.drawable.ic_launcher_background);
